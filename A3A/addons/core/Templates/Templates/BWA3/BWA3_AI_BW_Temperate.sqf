...
["vehiclesLightTanks",  ["BWA3_Puma_Fleck"]] call _fnc_saveToTemplate;
...
/* ANTISTASI PLUS STUFF START */
_loadoutData set ["traitorUniforms", ["BWA3_Uniform_tee_Fleck"]];
_loadoutData set ["traitorVests", ["BWA3_Vest_JPC_Leader_Fleck", "BWA3_Vest_JPC_Radioman_Fleck"]];
_loadoutData set ["traitorHats", ["BWA3_Booniehat_Fleck"]];

_loadoutData set ["officerUniforms", ["BWA3_Uniform2_sleeves_Fleck"]];
