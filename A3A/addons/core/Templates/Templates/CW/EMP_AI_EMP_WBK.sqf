...
_sfLoadoutData set ["jediUniform", ["JMSLLTE_JinHeavy_armorEmp_F_CombatUniform", "JMSLLTE_JinTrooper_armorEmp_F_CombatUniform", "JMSLLTE_JinTrooper_suitEmp_F_CombatUniform"]];
_sfLoadoutData set ["jediVest", ["GoG_HolsterSwordVest", "GoG_HolsterSwordVestBack"]];
_sfLoadoutData set ["jediHat", ["ls_jn_numbusCommando_helmet"]];
