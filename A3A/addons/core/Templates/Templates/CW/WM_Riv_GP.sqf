...
["vehiclesRivalsLightArmed", ["WM_V25_Speeder"]] call _fnc_saveToTemplate;
...
["vehiclesRivalsTanks", ["WM_AAC_Speeder","WM_AAC_Speeder_Rocket"]] call _fnc_saveToTemplate;
["vehiclesRivalsHelis", ["3AS_Patrol_LAAT_Republic"]] call _fnc_saveToTemplate;			
...
_loadoutData set ["offuniforms", ["WM_ParaMilitary_WD"]];
_loadoutData set ["vests", ["V_HarnessOGL_brn"]];
_loadoutData set ["heavyVests", ["V_HarnessO_brn"]];
_loadoutData set ["atBackpacks", ["Endor_Rebel_bag", "Black_WM_Rebel_bag"]];
_loadoutData set ["backpacks", ["Endor_Rebel_bag", "Black_WM_Rebel_bag"]];
_loadoutData set ["helmets", ["WM_ParaMilitary_Helmet_Wood"]];
_loadoutData set ["heavyHelmets", ["WM_ParaMilitary_Helmet_Wood"]];
...
_crewLoadoutData set ["vests", ["V_HarnessOGL_brn"]];
_crewLoadoutData set ["helmets", ["WM_ParaMilitary_Helmet_Wood"]];
