...
["vehiclesIFVs", ["LIB_Cromwell_Mk4", "LIB_Churchill_Mk7", "LIB_Cromwell_Mk4", "LIB_Churchill_Mk7_Crocodile", "LIB_Cromwell_Mk4", "LIB_Churchill_Mk7_Howitzer", "LIB_Churchill_Mk7_AVRE"]] call _fnc_saveToTemplate;
...
private _vehiclesLightTanks = ["LIB_Cromwell_Mk4"]; 
...
if (isClass (configFile >> "CfgPatches" >> "FA_WW2_Tanks")) then {
    _vehiclesLightTanks append ["FA_ValentineMk3","FA_ValentineMk3"];
};
