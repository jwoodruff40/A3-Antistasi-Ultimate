...
["name", "Communists"] call _fnc_saveToTemplate;
...
["vehiclesRivalsLightArmed", ["LIB_Kfz1_MG42"]] call _fnc_saveToTemplate;
["vehiclesRivalsTrucks", ["LIB_Zis5v"]] call _fnc_saveToTemplate;
["vehiclesRivalsCars", ["LIB_GazM1_SOV"]] call _fnc_saveToTemplate;
["vehiclesRivalsAPCs", ["LIB_SdKfz251_captured", "LIB_SdKfz251_captured_FFV"]] call _fnc_saveToTemplate;
["vehiclesRivalsTanks", ["LIB_M4A2_SOV", "LIB_T34_76"]] call _fnc_saveToTemplate;
["vehiclesRivalsHelis", ["LIB_Li2"]] call _fnc_saveToTemplate;			
...
_loadoutData set ["offuniforms", ["U_LIB_CIV_Functionary_1", "U_LIB_CIV_Functionary_2", "U_LIB_CIV_Functionary_3", "U_LIB_CIV_Functionary_4"]];
_loadoutData set ["vests", ["V_LIB_GER_VestKar98","V_LIB_GER_VestMP40"]];
_loadoutData set ["heavyVests", ["V_LIB_SOV_IShBrVestPPShMag"]];
_loadoutData set ["atBackpacks", ["B_LIB_SOV_RA_Rucksack2_Gas_Kit_Shinel_Green"]];
_loadoutData set ["backpacks", ["B_LIB_GER_SapperBackpack_empty"]];
_loadoutData set ["helmets", ["H_LIB_SOV_RA_Helmet", "H_LIB_GER_Helmet"]];
_loadoutData set ["heavyHelmets", ["H_LIB_SOV_RA_Helmet", "H_LIB_GER_Helmet"]];
...
_loadoutData set ["lightATLaunchers", ["LIB_Faustpatrone", "LIB_PzFaust_30m", "LIB_PzFaust_60m"]];
...
_loadoutData set ["sidearms", ["LIB_P08", "LIB_P38", "LIB_TT33", "LIB_M1895", "LIB_M1896"]];
...
_crewLoadoutData set ["vests", ["U_LIB_CIV_Citizen_1"]];
_crewLoadoutData set ["helmets", ["H_LIB_SOV_RA_Helmet", "H_LIB_GER_Helmet"]];

private _pilotLoadoutData = _loadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["vests", ["U_LIB_CIV_Citizen_1"]];
_pilotLoadoutData set ["helmets", ["H_LIB_SOV_RA_Helmet", "H_LIB_GER_Helmet"]];
