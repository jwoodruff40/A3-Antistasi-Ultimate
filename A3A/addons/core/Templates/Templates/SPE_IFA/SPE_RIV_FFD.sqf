...
["name", "FFD"] call _fnc_saveToTemplate;
["nameLeader", "Étienne Leclair"] call _fnc_saveToTemplate;
...
["vehiclesRivalsLightArmed", ["SPE_GER_R200_MG34"]] call _fnc_saveToTemplate;
["vehiclesRivalsTrucks", ["SPE_ST_OpelBlitz_Open"]] call _fnc_saveToTemplate;
["vehiclesRivalsCars", ["SPE_ST_R200_Unarmed"]] call _fnc_saveToTemplate;
["vehiclesRivalsAPCs", ["SPE_SdKfz250_1"]] call _fnc_saveToTemplate;
["vehiclesRivalsTanks", ["SPE_PzKpfwIII_J"]] call _fnc_saveToTemplate;
...
["handGrenadeAmmo", ["SPE_Shg24_Frag"]] call _fnc_saveToTemplate;
["mortarAmmo", ["Sh_82mm_AMOS"]] call _fnc_saveToTemplate;

["minefieldAT", ["SPE_TMI_42_MINE"]] call _fnc_saveToTemplate;
["minefieldAPERS", ["SPE_SMI_35_MINE"]] call _fnc_saveToTemplate;
...
_loadoutData set ["offuniforms", ["U_SPE_milice_3","U_SPE_milice_3_CD","U_SPE_milice_3_CDA","U_SPE_milice_3_CR","U_SPE_milice_3_CT"]];
_loadoutData set ["vests", ["V_SPE_Milice_Vest_rifle","V_SPE_milice_Vest_smg"]];
_loadoutData set ["heavyVests", ["V_SPE_milice_Vest_MG_sidearm"]];
_loadoutData set ["atBackpacks", ["B_SPE_CIV_musette"]];
_loadoutData set ["backpacks", ["B_SPE_CIV_satchel","B_SPE_FFI_Gasbag"]];
_loadoutData set ["helmets", ["H_SPE_GER_Helmet", "H_SPE_GER_Helmet_M40"]];
_loadoutData set ["heavyHelmets", ["H_SPE_GER_Helmet", "H_SPE_GER_Helmet_M40"]];
...
_loadoutData set ["lightHELaunchers", ["SPE_PzFaust_60m", "SPE_PzFaust_30m", "SPE_Faustpatrone"]];
_loadoutData set ["AALaunchers", ["SPE_Faustpatrone"]];
...
_crewLoadoutData set ["vests", ["U_SPE_milice_3"]];
_crewLoadoutData set ["helmets", ["H_SPE_GER_Helmet", "H_SPE_GER_Helmet_M40"]];

private _pilotLoadoutData = _loadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["vests", ["U_SPE_milice_3"]];
_pilotLoadoutData set ["helmets", ["H_SPE_GER_Helmet", "H_SPE_GER_Helmet_M40"]];
