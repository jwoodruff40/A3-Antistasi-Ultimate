...
_loadoutData set ["offuniforms", ["SCE_Duty_CBRN"]];
...
_crewLoadoutData set ["uniforms", ["SCE_Duty_CBRN"]];
_crewLoadoutData set ["vests", ["SCE_V_SEVA_Duty"]];
_crewLoadoutData set ["helmets", ["CUP_H_Ger_M92_Black"]];

private _pilotLoadoutData = _loadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["uniforms", ["SCE_Duty_CBRN"]];
_pilotLoadoutData set ["vests", ["SCE_V_SEVA_Duty"]];
