...
private _vehAA = (GetTiered(_faction, "vehiclesAA")) select { A3A_vehicleResourceCosts get _x >= 100 };
...
[GetTiered(_faction, "vehiclesLightArmed"), _carWeight] call _fnc_addArrayToWeights;
