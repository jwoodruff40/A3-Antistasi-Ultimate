...
private _isMilitia = _veh in ((GetTiered(_faction, "vehiclesLightArmed")) + (GetTiered(_faction, "vehiclesTrucks")) + (GetTiered(_faction, "vehiclesLightUnarmed")) + (GetTiered(_faction, "vehiclesAPCs")));
