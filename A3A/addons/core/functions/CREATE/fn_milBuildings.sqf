...
switch (true) do {
    case (_markerX in milbases): {
        _helicopterTypes append (GetTiered(_faction, "vehiclesHelisTransport"));
        _helicopterTypes append (GetTiered(_faction, "vehiclesHelisLight"));
        _helicopterTypes append (GetTiered(_faction, "vehiclesHelisLightAttack"));
    };
    case (_markerX in airportsX): {
        _helicopterTypes append (GetTiered(_faction, "vehiclesHelisTransport"));
        _helicopterTypes append (GetTiered(_faction, "vehiclesHelisLight"));
        _helicopterTypes append (GetTiered(_faction, "vehiclesHelisLightAttack"));
        _helicopterTypes append (GetTiered(_faction, "vehiclesHelisAttack"));
    };
    default {
        _helicopterTypes append (GetTiered(_faction, "vehiclesHelisLight"));
    };
...
for "_i" from 0 to (count _buildings) - 1 do
{
    ...
    call {
        ...
        {
            private _type = selectRandom (GetTiered(_faction, "staticMGs"));
        ...
        {
            private _type = selectRandom (GetTiered(_faction, "staticAA"));
            private _dir = getDir _building;
        ...
        {
            private _type = selectRandom (GetTiered(_faction, "staticAT"));
            private _dir = (getDir _building) - 180;
