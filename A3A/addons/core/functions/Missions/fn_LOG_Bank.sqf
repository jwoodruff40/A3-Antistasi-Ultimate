...
private _vehiclePool = if (_civDisabled) then { GetTiered(_faction, "vehiclesMilitiaTrucks") } else { FactionGetTiered(civ, "vehiclesCivIndustrial") } select { _x isEqualType "" }; // * convert weighted list to normal array 
