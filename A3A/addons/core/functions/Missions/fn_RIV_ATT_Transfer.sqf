...
if (_isDifficult) then {
    ...
    private _prizeClass = selectRandom ((FactionGetTiered(riv, "vehiclesLightArmed")) + (FactionGetTiered(riv, "vehiclesLightUnarmed")) + (FactionGetTiered(riv, "vehiclesAPCs")) + (FactionGetTiered(riv, "vehiclesTanks")) + (FactionGetTiered(riv, "vehiclesHelis")));
...
private _vehicletransferClass = if (_isDifficult) then { selectRandom ((GetTiered(_faction, "vehiclesCargoTrucks")) + (FactionGetTiered(riv, "vehiclesAPCs")) + (FactionGetTiered(riv, "vehiclesTanks")));
    } else {
        selectRandom ((GetTiered(_faction, "vehiclesCargoTrucks")) + (FactionGetTiered(riv, "vehiclesLightArmed")));
...
private _escortvehicle = if (_isDifficult) then {
    selectRandom ((GetTiered(_faction, "vehiclesLightAPCs")) + (GetTiered(_faction, "vehiclesAPCs")) + (GetTiered(_faction, "vehiclesIFVs")) + (GetTiered(_faction, "vehiclesLightArmed")) + 
    (GetTiered(_faction, "vehiclesTrucks")));
} else {
    selectRandom ((GetTiered(_faction, "vehiclesLightArmed")) + (GetTiered(_faction, "vehiclesTrucks")) + (GetTiered(_faction, "vehiclesLightArmed")) + 
    (GetTiered(_faction, "vehiclesLightUnarmed")) + (GetTiered(_faction, "vehiclesAPCs")) + (GetTiered(_faction, "vehiclesTrucks")));
}; //check if vehicle is truck, if yes create a group and move in
private _convoylead = if (_isDifficult) then {
    selectRandom ((GetTiered(_faction, "vehiclesLightArmed")) + (GetTiered(_faction, "vehiclesTrucks")));
} else {
    selectRandom ((GetTiered(_faction, "vehiclesLightArmed")) + (GetTiered(_faction, "vehiclesTrucks")) + (GetTiered(_faction, "vehiclesLightArmed")) + 
    (GetTiered(_faction, "vehiclesLightUnarmed")) + (GetTiered(_faction, "vehiclesTrucks")) + (GetTiered(_faction, "vehiclesLightUnarmed")));
};
