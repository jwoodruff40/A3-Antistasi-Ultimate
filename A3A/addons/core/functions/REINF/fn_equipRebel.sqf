...
*
* Example Usage:
* ["startEquipRebel", [_unit, 2]] call A3A_fnc_equipRebel;
* ["startEquipRebel", [player, 0, currentRebelLoadout]] call A3A_fnc_equipRebel;
* ["addSecondaryAndMags", [_unit, _weapon, _totalMagWeight]] call A3A_fnc_equipRebel;
*/
...
switch (_mode) do {
    ...
    case ("startEquipRebel"): {
        ...
        if (!isNil "_customLoadout") exitWith { ["applyCustomLoadout", [_unit]] call A3A_fnc_equipRebel };
        
        ["addRadio", [_unit]] call A3A_fnc_equipRebel;
        ["addHeadgear", [_unit]] call A3A_fnc_equipRebel;
        ["addVest", [_unit]] call A3A_fnc_equipRebel;
        ["addBackpack", [_unit]] call A3A_fnc_equipRebel;
        ["addGrenades", [_unit]] call A3A_fnc_equipRebel;
        ["addPrimary", [_unit]] call A3A_fnc_equipRebel;
        ["addNVGs", [_unit]] call A3A_fnc_equipRebel;
    ...
    case ("addSecondayAndMags"): {
        _params params ["_unit", "_weapon", "_totalMagWeight"];
