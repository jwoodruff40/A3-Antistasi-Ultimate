...
private _MedicalVehicleClass = selectRandom ((GetTiered(_faction, "vehiclesMedical")) + (GetTiered(_faction, "vehiclesHelisTransport"))); // Get a random medical vehicle class
