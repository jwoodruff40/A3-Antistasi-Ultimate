...
private _civHeli = GetTiered(A3A_faction_civ, "vehiclesCivHeli");
...
private _civHeliData = [[(_spawnPosition select 0), (_spawnPosition select 1), 100 + random 200], 0, selectRandom (FactionGetTiered(civ, "vehiclesCivHeli")), civilian] call A3A_fnc_spawnVehicle;
