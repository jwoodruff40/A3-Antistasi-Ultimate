...
[Invaders, _cityPos getPos [300, random 360 + 180], (FactionGetTiered(inv, "vehiclesLightArmed")) + (FactionGetTiered(inv, "vehiclesLightArmed")) + (FactionGetTiered(inv, "vehiclesLightUnarmed")) + (FactionGetTiered(inv, "vehiclesLightUnarmed")), selectRandom ([A3A_faction_inv, "groupsTierSmall"] call SCRT_fnc_unit_flattenTier)] call _fnc_spawnForces;
