...
private _truckClass = selectRandom ((GetTiered(_faction, "vehiclesAmmoTrucks")) + (GetTiered(_faction, "vehiclesRepairTrucks")) + (GetTiered(_faction, "vehiclesFuelTrucks")) + (GetTiered(_faction, "vehiclesMedical")));
