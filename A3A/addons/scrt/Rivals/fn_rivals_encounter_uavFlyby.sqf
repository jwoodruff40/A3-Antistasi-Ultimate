...
if ((FactionGetTiered(riv, "vehiclesRivalsUavs")) isEqualTo []) exitWith {
...
for "_i" from 0 to _uavQuantity - 1 do {
	...
	private _uav = createVehicle [selectRandom (FactionGetTiered(riv, "vehiclesRivalsUavs")), _spawnPosition, [], 0, "FLY"];
