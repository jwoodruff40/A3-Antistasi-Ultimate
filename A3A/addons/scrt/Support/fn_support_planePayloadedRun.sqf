...
private _planeData = [_originPosition, _angle, selectRandom (FactionGetTiered(reb, "vehiclesPlane")), teamPlayer] call A3A_fnc_spawnVehicle;
...
switch (supportType) do {
	...
	case ("VEH_AIRDROP"): {
		_wp1 setWaypointStatements ["true", format ["if !(local this) exitWith {}; [this, '%1', '%2'] spawn SCRT_fnc_common_supplyDrop", selectRandom (FactionGetTiered(reb, "vehiclesBasic")), supportType]];
